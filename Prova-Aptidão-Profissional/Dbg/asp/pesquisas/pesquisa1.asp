...
<% 
	...
	rsClientes.Source = "SELECT * FROM cliente WHERE sigla = " + "'" + Request.Form("sigla") + "'"
...
<p align="center"><big>Indique sigla da escola : </big></p>

<form method="POST" action="pesquisa1.asp">
  <p>
  <input type="text" name="sigla" size="20"> 
